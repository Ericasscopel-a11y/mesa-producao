  ...
  return (
    <div style={{ padding: pad, maxWidth: 880, margin: "0 auto" }}>
      ...
      <p style={{ fontSize: 13.5, color: C.muted, lineHeight: 1.55, marginTop: 0, marginBottom: 18 }}>
        Suas skills de criação de conteúdo. Comece pela base (<b style={{ color: C.text }}>1) Persona → 2) Linha Editorial → 3) Planejamento Mensal</b>), use <b style={{ color: C.text }}>4) Modela</b> e <b style={{ color: C.text }}>5) Rotina</b> no dia a dia, e finalize tudo com <b style={{ color: C.text }}>6) Humanizer</b>. Toque em cada uma para ver os detalhes e baixar o arquivo.
      </p>
