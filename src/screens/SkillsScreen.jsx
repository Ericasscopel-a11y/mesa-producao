  ...
  return (
    <div style={{ padding: pad, maxWidth: 880, margin: "0 auto" }}>
      ...
      <p style={{ fontSize: 13.5, color: C.muted, lineHeight: 1.55, marginTop: 0, marginBottom: 18 }}>
        Suas skills de criação de conteúdo. Siga a ordem: <b style={{ color: C.text }}>1) Persona → 2) Linha Editorial → 3) Planejamento Mensal → 4) Modela Conteúdo → 5) Humanizer</b>. Toque em cada uma para ver os detalhes e baixar o arquivo.
      </p>
